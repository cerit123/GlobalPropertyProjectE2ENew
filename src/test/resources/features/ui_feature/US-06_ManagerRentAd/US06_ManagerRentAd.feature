@US06
Feature: Manager kiralık ilan oluşturabilmeli


  @US06TC01
  Scenario: manager rolündeki kullanıcı kiralık ilan oluştururken "common information", "adress information" ve "properties" bilgilerini girebilmeli
...
#    PROPERTIES
  ...
  @US06TC04
  Scenario:  Kullanıcı kiralık ilan oluştururken resim ekleyebilmeli
    Given Sayfaya gidilir
    When Manager olarak giris yapilir
    And Dashboard sayfasindan ana sayfaya geri donulur
    And Create property sekmesine tiklanir
  ...
  @US06TC05
  Scenario:  Kullanıcı kiralık ilan oluştururken 3MB dosya boyutundan fazla olan bir resim  dosyası ekleyememelidir
    Given Sayfaya gidilir
    When Manager olarak giris yapilir
    And Dashboard sayfasindan ana sayfaya geri donulur
    And Create property sekmesine tiklanir
